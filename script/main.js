...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const catButton1 = document.querySelector("#b1");
  const catButton2 = document.querySelector("#b2");
  const catButton3 = document.querySelector("#b3");
  const catButton4 = document.querySelector("#b4");
  catButton1.addEventListener("click", function () {
    setTimeout(() => {
      randomImage.src = "images/cat_1.jpg";
    }, 100);
  });
  catButton2.addEventListener("click", function () {
    setTimeout(() => {
      randomImage.src = "images/cat_2.jpg";
    }, 100);
  });
  catButton3.addEventListener("click", function () {
    setTimeout(() => {
      randomImage.src = "images/cat_3.jpg";
    }, 100);
  });
  catButton4.addEventListener("click", function () {
    setTimeout(() => {
      randomImage.src = "images/cat_4.jpg";
    }, 100);
  });
});
